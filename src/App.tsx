      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6 text-center">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl space-y-6">
          ...
          <div className="space-y-3 pt-4 border-t border-slate-100">
            ...
            <button
              onClick={() => logout()}
              className="flex items-center justify-center w-full gap-2 p-3 mt-4 text-rose-500 hover:bg-rose-50 rounded-xl font-medium transition-colors border border-transparent hover:border-rose-100"
            >
              Tizimdan Chiqish
            </button>
          </div>
